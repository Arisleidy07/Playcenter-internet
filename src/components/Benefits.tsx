...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Activamos tu servicio en menos de 48 horas después de tu solicitud.",
  },
  {
    icon: <Wifi className="h-10 w-10 text-blue-600" />,
    title: "Conexión de Alta Velocidad",
    description:
      "Disfruta de velocidades simétricas de descarga y subida para todas tus actividades online.",
  },
  {
    icon: <Shield className="h-10 w-10 text-blue-600" />,
    title: "Conexión Segura",
    description:
      "Implementamos protocolos de seguridad que protegen tu red de amenazas externas.",
  },
  {
    icon: <Tools className="h-10 w-10 text-blue-600" />,
    title: "Mantenimiento Gratuito",
    description:
      "Incluimos mantenimiento de equipos sin costo adicional durante toda la vigencia de tu contrato.",
  },
  {
    icon: <Headphones className="h-10 w-10 text-blue-600" />,
    title: "Atención Personalizada",
    description:
      "Te asignamos un asesor personal para gestionar tus consultas y requerimientos.",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Descubre por qué miles de clientes confían en nosotros para sus
